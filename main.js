...
function keyEvent(event) {
  ...
  audio.play();
    ...
    document.querySelector('.backCover').style.display = "block";
...
// //GLOBAL VARIABLES
// var videoPlayer = document.getElementsByClassName('videoContainer');
// var playPause = document.getElementById('playPause');
...
// var prevLink = videoList[videoList.length-1],
// getAttribute('src');
// var prevID = videoLink